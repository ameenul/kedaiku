...
import com.example.kedaiku.UI.customer_menu.AddCustomerActivity;
import com.example.kedaiku.UI.customer_menu.CustomerAdapter;
import com.example.kedaiku.UI.customer_menu.CustomerDetailActivity;
import com.example.kedaiku.UI.customer_menu.CustomerListActivity;
import com.example.kedaiku.UI.customer_menu.GroupListActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new CustomerAdapter.OnItemClickListener() {
            ...
            public void onEditClicked(Customer customer) {
                ...
                Intent intent = new Intent(CustomerSelectActivity.this, CustomerDetailActivity.class);
            ...
            public void onDeleteClicked(Customer customer) {
                ...
                new AlertDialog.Builder(CustomerSelectActivity.this)
                        ...
                        .setPositiveButton("Ya", (dialog, which) -> {
                            ...
                            Toast.makeText(CustomerSelectActivity.this, "Pelanggan dihapus", Toast.LENGTH_SHORT).show();
                        })
            ...
            public void onItemClicked(Customer customer) {
                // Kembalikan hasil dengan id dan nama customer
                Intent resultIntent = new Intent();
                resultIntent.putExtra("customer_id", customer.getId());
                resultIntent.putExtra("customer_name", customer.getCustomer_name());
                resultIntent.putExtra("customer_groupId", customer.getCustomer_group_id());
        ...
        buttonManageGroup.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(CustomerSelectActivity.this, GroupListActivity.class);
            startActivity(intent);
        });
